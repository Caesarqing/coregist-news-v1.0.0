...
class ServiceSettings:
    ...
    ai_content_model: str = os.getenv("AI_CONTENT_MODEL", "dmax")
    ai_content_remote_model: str = os.getenv("AI_CONTENT_REMOTE_MODEL", "Qwen3.5-2B-free")
    ai_content_base_url: str = os.getenv("AI_CONTENT_BASE_URL", "https://www.dmxapi.cn/v1")
    ai_content_api_key: str = os.getenv("AI_CONTENT_API_KEY", "")
    ...
    ai_review_model: str = os.getenv("AI_REVIEW_MODEL", "dmax")
    ai_review_remote_model: str = os.getenv("AI_REVIEW_REMOTE_MODEL", "Qwen3.5-2B-free")
    ai_review_base_url: str = os.getenv("AI_REVIEW_BASE_URL", "https://www.dmxapi.cn/v1")
